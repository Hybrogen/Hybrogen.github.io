...
- [常用命令 - new](#常用命令---new)
  ...
  - [**2. 指定范围操作1**](#2-指定范围操作1)
  - [**3. 指定范围操作2**](#3-指定范围操作2)
  - [**4. 运行 bash 命令**](#4-运行-bash-命令)
  - [**5. normal 命令**](#5-normal-命令)
  - [**6. 宏命令**](#6-宏命令)
- [修改 vimrc 文件 - 强大的自定义命令!](#修改-vimrc-文件---强大的自定义命令)
  - [**set vim 设置**](#set-vim-设置)
  - [**map 自定义映射关系**](#map-自定义映射关系)
- [强大的命令宏](#强大的命令宏)
- [重要事项](#重要事项)
- [后话](#后话)
- [参考视频](#参考视频)
...
![chosearea1](/images/20200323/1.gif)
...
![chosearea2](/images/20200323/2.gif)
...
![rshow](/images/20200323/3.gif)

#### **5. normal 命令**
你可以对每一行都进行相同的操作【插入文字
1. `V` 选中行，上下箭头选中多行
2. `:` 进入输入命令的模式
3. 在 `normal` 命令之后写自己的操作
