...
### 目录
* [简介](#简介)
* [getline(cin, string()) 函数](#getline(cin,-string())-函数)
* [string 的 .c_str() 方法和 sscanf() 函数](#string-的-.c_str()-方法和-sscanf()-函数)
  - [sscanf()](#sscanf())
* [stringstream 对象](#stringstream-对象)
  - [ss 额外栗子](#最后再给你们整几个栗子)
* [cout << fixed << setprecision(2) << doubnle(); 控制输出位数](#cout-<<-fixed-<<-setprecision(2)-<<-doubnle();-控制输出位数)
* [二元组 pair<T, T> 的使用方法](#二元组-pair<T,-T>-的使用方法)
  - [pair 额外栗子](#)
...
### cout << fixed << setprecision(2) << doubnle(); 控制输出位数
