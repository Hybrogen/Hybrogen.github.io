...
本文是关于线段树的 **建树方法** 和 **建树原理** 的讲解，如果你已经对于线段树的数据结构非常了解，请直接进入下一篇文章 [线段树的基础操作](https://hybrogen.github.io/2019/09/SegmentTree2/)
...
* [线段树的结构（数据结构）](#线段树的结构（数据结构）)
  ...
  - [四倍原数据](#四倍原数据)
* [线段树的小小总结](#线段树的小小总结)
* [线段树的基础操作](https://hybrogen.github.io/2019/09/SegmentTree2/)
