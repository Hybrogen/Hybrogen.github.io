...
* 如果你已经对于线段树的数据结构非常了解，请直接进入下一篇文章 [线段树的基础操作](https://hybrogen.github.io/2019/09/SegmentTree2/)
* 如果你对线段树很懂却不小心点进来，要不要去看看离散化呢~|wo [线段树 + 离散化](https://hybrogen.github.io/2020/03/SegmentTree3/)

### 目录
* [线段树的意义](#线段树的意义)
* [浅谈线段树（问题分析）](#浅谈线段树（问题分析）)
* [线段树的结构（数据结构）](#线段树的结构（数据结构）)
  - [标记方法](#标记方法)
  - [四倍原数据](#四倍原数据)
* [线段树的小小总结](#线段树的小小总结)
...
接下来的线段树请观看 [线段树的基础操作](https://hybrogen.github.io/2019/09/SegmentTree2/)
